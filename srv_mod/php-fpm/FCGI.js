...
function createHeader(version, type, requestId, contentLength, paddingLength) {
    ...
    buff[6] = paddingLength; // unsigned char paddingLength // unsigned char reserved
...
function createBeginRequestBody(role, flags) {
    ...
    buff[2] = flags; // unsigned char flags // unsigned char reserved[5]
...
function parseEndRequest(buff) {
    ...
    const protocolStatus = buff[4]; // unsigned char protocolStatus // unsigned char reserved[3]
